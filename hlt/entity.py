...
class Planet(Entity):
	...
	def get_planet_owner(self):
		"""
		Obtain the owner of this planet.
		
		:return: return the planet owner
		:rtype: str
		"""
		return self.owner
...
class Ship(Entity):
	...
	def get_ship_id(self):
		...
		:return: return the ship id
		:rtype: int
		"""
		return self.id
		
	def get_docked_planet(self):
		"""
		Obtain the planet where the ship is docked.
		
		:return: return the planet
		:rtype: int
		"""
		return self.planet
